...
<!-- sp.ac3_cowboylayouts-horizontal time log Thu, 08 Jun 2023 03:57:16 GMT -->
<head>
    <meta charset="utf-8"/>
    <title>Login</title>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('auth.login.post') }}" method="post">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="email" name="email" class="form-control form-control-sm" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" required>
                                        <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                                    </div>
                                    <div class="mb-0">
                                        <label for="exampleInputPassword1" class="form-label">Password</label>
                                        <input type="password" name="password" class="form-control form-control-sm" id="exampleInputPassword1" placeholder="Password" required>
                                    </div>
                                    <div class="mb-2">
...
<!-- sp.ac3_cowboylayouts-horizontal time log Thu, 08 Jun 2023 03:57:17 GMT -->
</html>
