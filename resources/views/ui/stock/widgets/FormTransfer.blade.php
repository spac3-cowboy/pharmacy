            ...
            <div class="card-body">
                <div class="row justify-content-around">
                    <div class="col-7">
                        ...
                        <ul class="list-group mt-2 border border-5 border-danger bg-pitla-blue">
                            <li class="list-group-item" id="selected-medicine-name">
                            ...
                            <li class="list-group-item" id="selected-customer-name">
                                <div class="form-group">
                                    ...
                                    <textarea name="" id="note" cols="10" rows="5" class="form-control"></textarea>
                                </div>
                            </li>

                        </ul>
                        <button onclick="transfer()" class="btn btn-success mt-2">
                            Transfer
                        </button>
                    </div>
                </div>
	...
	const transfer = () => {
        ...
        .then(async (result) => {
			...
			if (result.isConfirmed) {
                ...
                let res = await fetch("/dashboard/transfer/store", {
                              method: "POST",
                              body: payload
                          }).then(res=>res.json());
                if( res.msg == "success" ) {
