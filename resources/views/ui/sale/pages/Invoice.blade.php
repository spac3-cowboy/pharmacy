...
<div class="table-responsive">
    <div id="invoice" class="row">
        <section style="width: 302px; margin: 10px auto;background-color: #fff; padding:5px; overflow: hidden;" id="invoiceArea">
            <header style="text-align: center; padding-bottom: 0px">
                <h2 style="font-size: 24px; font-weight: 700; margin: 0; padding: 0;">
                    {{ App\Models\Setting\Setting::key("site_name") }}
                </h2>
                <div style="margin-bottom: 5px; line-height: 1;">
                    <span style="font-size: 12px;">Zac Mbao</span>
                    <div style="display: block;">
                        <span style="font-size: 12px;">
                            Mobile: {{ App\Models\Setting\Setting::key("site_phone") }}
                        </span> <br />
                        <span style="font-size: 12px;">
                            Email: {{ App\Models\Setting\Setting::key("site_email") }}
                        </span>
                    </div>
                </div>
            </header>
                ...
                <table style="width: 100%">
                    <thead>
                        <tr style="border-top: 1px solid #000; border-bottom: 1px solid #000; font-weight: 700;">
                            ...
                            <th class="w-20 text-right" style="border-bottom: none; font-size: 12px; text-align: center">
                                Total
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($sale->items as $item)
                            <tr style="border-top: 1px solid #000; border-bottom: 1px solid #000;">
                                <td class="text-center" style="vertical-align: top; font-size: 12px; text-align: center">1</td>
            ...
            <section style="line-height: 1.222; font-size: 12px; font-style: italic; padding: 0px 0">
                <span
                    style="line-height: 1.222; font-size: 12px; font-style: italic;"><b>In Text:</b> {{ strtoupper(NumberToWords\NumberToWords::transformNumber('en', $sale->grand_total)) }}</span><br>
            </section>
            --------------------------------------------------------
            ...
            <section style="line-height: 1.222;">
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px;text-align: right;">{{ $sale->grand_total }}</td>
                    </tr>
                    <tr>
                        <td style="font-size: 12px;">-RECEIVED PAYMENT</td>
                        <td style="font-size: 12px;text-align: right;">{{ $sale->paid }}</td>
                    </tr>
                    <tr>
                        <td style="font-size: 12px;">-RETURNED AMOUNT</td>
                        <td style="font-size: 12px;text-align: right;">{{ $sale->due }}</td>
                    </tr>
                    </tbody>
                </table>
            </section>
